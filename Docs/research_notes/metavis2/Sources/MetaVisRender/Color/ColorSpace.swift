...
// Color space conversion utilities using existing IngestionTypes

import Foundation
import simd

// Use the existing ColorPrimaries and TransferFunction from IngestionTypes
// This file adds ACEScg support and conversion matrices

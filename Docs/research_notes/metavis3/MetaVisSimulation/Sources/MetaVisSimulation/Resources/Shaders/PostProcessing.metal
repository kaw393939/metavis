...
#include "Effects/FaceEnhance.metal"  // AI-powered face enhancement
#include "Effects/BackgroundBlur.metal"  // Person segmentation-based background blur
...
kernel void final_composite(
    ...
    if (tonemapOperator == TM_ACES_FULL) {
        ...
        switch (odt) {
            ...
            case ODT_SRGB_SDR:    
                // ACEScg_to_Rec709_SDR already applies gamma 2.4
                // For sRGB, we need to undo Rec709 gamma and apply sRGB gamma
                // Note: Rec709 gamma (2.4) and sRGB gamma are very similar but not identical
